      ...
      <div className={classes.gridProjects}>
        <div className={`${classes.project} ${classes.firstProject}`}>
          ...
          <div className={classes.photoBlock}>
            ...
            <div className={classes.buttons}>
              <a href='https://github.com/tinatripak/HarmonyMusicClient'className={classes.liveCodeButton}>Live code</a>
              <a href='https://harmony-music-client.vercel.app/login'className={classes.demoButton} >Demo</a>
            </div>
          </div>
          <p className={classes.description}>
            ...
            bright world of Ukrainian melody!<br/><br/>The site was built using the{" "}
            <span>MERN stack</span>, and I also used <span>Firebase</span> to
            authorize and store photos and music.
          </p>
        </div>
        ...
        <div className={`${classes.project} ${classes.secondProject}`}>
          <p className={classes.description}>
            ...
            question you are interested in. <br/><br/>The website was built using the{" "}
            <span>MERN stack</span>, and for storing photos in the database, I
            utilized <span>Cloudinary</span>.
          </p>
          <div className={classes.photoBlock}>
            <img
            ...
            />
            <div className={classes.buttons}>
              <a href='https://github.com/tinatripak/photograph-portfolio-client'className={classes.liveCodeButton}>Live code</a>
              <a href='https://ksigallery.vercel.app'className={classes.demoButton} >Demo</a>
            </div>
          </div>
        ...
        <div className={`${classes.project} ${classes.thirdProject}`}>
          <p className={classes.description}>
            ...
            footer in the form of a photo. It was a project from the course. <br/><br/>The
            web page was built using <span>React.js library</span>.
          </p>
          <div className={classes.photoBlock}>
            <img
            ...
            />
            <div className={classes.buttons}>
              <a href='https://github.com/tinatripak/bose-react' className={classes.liveCodeButton}>Live code</a>
              <a href='https://bose-react.vercel.app'className={classes.demoButton} >Demo</a>
            </div>
          </div>
        ...
        <div className={`${classes.project} ${classes.fourthProject}`}>
          ...
          <p className={classes.description}>
            ...
            Authentication and authorization with email and password.<br/><br/>The web
            page was built using <span>React.js library</span> and{" "}
            <span>Firebase</span>.
          </p>
        </div>
      </div>
